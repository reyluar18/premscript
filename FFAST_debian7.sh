...
# install screenfetch
cd
wget -O /usr/bin/screenfetch "https://raw.githubusercontent.com/reyluar18/premscript/master/screenfetch"
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/reyluar18/premscript/master/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/reyluar18/premscript/master/badvpn-udpgw64"
fi
...
# install mrtg
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/reyluar18/premscript/master/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/reyluar18/premscript/master/mrtg-mem.sh"
...
curl "https://raw.githubusercontent.com/reyluar18/premscript/master/mrtg.conf" >> /etc/mrtg.cfg
...
wget https://raw.githubusercontent.com/reyluar18/premscript/master/dropbear-2018.76.tar.bz2
...
# install vnstat gui
cd /home/vps/public_html/
wget https://raw.githubusercontent.com/reyluar18/premscript/master/vnstat_php_frontend-1.5.1.tar.gz
...
wget -O /etc/stunnel/stunnel.pem "https://raw.githubusercontent.com/reyluar18/premscript/master/updates/stunnel.pem"
wget -O /etc/stunnel/stunnel.conf "https://raw.githubusercontent.com/reyluar18/premscript/master/req/stunnel.conf"
...
cd
wget https://raw.githubusercontent.com/reyluar18/premscript/master/updates/install-premiumscript.sh -O - -o /dev/null|sh
